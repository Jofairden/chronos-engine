package chronos.engine.domain.api

import chronos.engine.core.api.IExternalApi
...
import chronos.engine.domain.core.RoutesImpl
...
abstract class ExternalApi : IExternalApi, RoutesImpl() {
  ...
  suspend inline fun <reified T : Any> org.openapitools.client.infrastructure.HttpResponse<T>.handle(
